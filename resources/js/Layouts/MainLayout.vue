        ...
        <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6" v-if="$page.props.auth">
                        ...
                        <div class="ms-3 relative">
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    <DropdownLink :href="route('admin.dashboard')" v-if="$page.props.auth.permissions.includes('administrator')"> Admin </DropdownLink>
            ...
            >
                <div class="pt-2 pb-3 space-y-1">
                    <ResponsiveNavLink :href="route('home')" :active="route().current('link1')">
                        link1
                    </ResponsiveNavLink>
                    <ResponsiveNavLink :href="route('home')" :active="route().current('link2')">
                        link2
                    </ResponsiveNavLink>
                    <ResponsiveNavLink :href="route('home')" :active="route().current('link3')">
                        link3
                    </ResponsiveNavLink>
                </div>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600" v-if="$page.props.auth">
                    ...
                    <div class="mt-3 space-y-1">
                        <ResponsiveNavLink :href="route('admin.dashboard')" v-if="$page.props.auth.permissions.includes('administrator')"> Admin </ResponsiveNavLink>
                ...
                <div class="pb-1 border-t border-gray-200 dark:border-gray-600" v-else>
                    <div class="mt-3 space-y-1">
